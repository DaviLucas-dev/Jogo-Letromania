...
public class NivelDificil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setBounds(680, 20, 60, 30);

        jLabel12.setFont(new java.awt.Font("Mistral", 1, 18)); // NOI18N
        jLabel12.setText("0");
        getContentPane().add(jLabel12);
        jLabel12.setBounds(280, 10, 120, 40);
        ...
        jButton11.setBounds(50, 430, 170, 60);
        ...
        jLabel13.setBounds(0, -20, 800, 560);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String nome1 = "recorde";
        String nome2 = getjTextField1().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        
        
        
        if(nome1.equals(nome2)){
         
            getjLabel1().setText("correto!");
        
            setAcertou(java.applet.Applet.newAudioClip(getClass().getResource("/musicas/SomDeAcerto.wav")));
            getAcertou().play();
            
         s = a+1;
            getjLabel12().setText(Integer.toString(s));       
            
            getjButton1().setEnabled( false ); // para desabilitar um botao.
         ...
         if(a==9){
           ...
           if(b==9){
               ...
               dispose(); //para fechar uma janela e abrir outra
                ...
                getjLabel11().setText(Integer.toString(s2)); 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String nome1 = "rubrica";
        String nome2 = getjTextField2().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton2().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String nome1 = "deboche";
        String nome2 = getjTextField3().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton3().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String nome1 = "madrasta";
        String nome2 = getjTextField4().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton4().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String nome1 = "padrasto";
        String nome2 = getjTextField5().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton5().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String nome1 = "pesquisa";
        String nome2 = getjTextField6().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton6().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        String nome1 = "enxergar";
        String nome2 = getjTextField7().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton7().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        String nome1 = "confusão";
        String nome2 = getjTextField8().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton8().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        String nome1 = "discussão";
        String nome2 = getjTextField9().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton9().setEnabled( false ); // para desabilitar um botao.
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        String nome1 = "perturbar";
        String nome2 = getjTextField10().getText();
        int a = Integer.parseInt(getjLabel12().getText()),s,s2,b = Integer.parseInt(getjLabel11().getText());
        ...
        if(nome1.equals(nome2)){
         ...
         s = a+1;
            ...
            getjButton10().setEnabled( false ); // para desabilitar um botao.
